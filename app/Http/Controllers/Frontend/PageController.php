...
class PageController extends Controller
{
    ...
    public function getPageBySlug($title)
    {
        $datalist = Page::where('slug', '=', $title)->where('is_publish', '=', 1)->get();
        $data = array(
            'title' => '',
            'slug' => '',
            'content' => '',
      ...
      public function getPageStory()
    {
        $datalist = Page::where('slug', '=', 'about-us')->where('is_publish', '=', 1)->get();
        $data = array(
            'title' => '',
            'slug' => '',
            'content' => '',
