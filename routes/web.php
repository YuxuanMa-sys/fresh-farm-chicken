...
Route::get('/page/{title}', [App\Http\Controllers\Frontend\PageController::class, 'getPageBySlug'])->name('frontend.page');
Route::get('/our-story', [App\Http\Controllers\Frontend\PageController::class, 'getPageStory'])->name('frontend.page');
