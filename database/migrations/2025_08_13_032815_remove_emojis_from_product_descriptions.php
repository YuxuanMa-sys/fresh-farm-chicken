    ...
    public function up(): void
    {
        ...
        foreach ($products as $product) {
            ...
            if (!empty($product->short_desc)) {
                $updates['short_desc'] = $this->removeEmojis($product->short_desc);
            }
            
            // Clean description if it exists
            if (!empty($product->description)) {
                $updates['description'] = $this->removeEmojis($product->description);
            }
            
            // Clean og_description if it exists
            if (!empty($product->og_description)) {
                $updates['og_description'] = $this->removeEmojis($product->og_description);
            }
            
            // Clean og_keywords if it exists
            if (!empty($product->og_keywords)) {
                $updates['og_keywords'] = $this->removeEmojis($product->og_keywords);
            }
