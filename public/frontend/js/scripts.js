...
(function ($) {
	...
	//Featured Categories
	var featuredCategoriesCount = $('.featured-categories .featured-card').length;
	$('.featured-categories').owlCarousel({
		...
		responsive:{
			...
			600:{
				items: Math.min(2, featuredCategoriesCount),
				nav: false
			},
			900:{
				items: Math.min(3, featuredCategoriesCount)
			},
			1000:{
				items: Math.min(4, featuredCategoriesCount)
			}
		}
	});
	...
	var categoryCarouselCount = $('.category-carousel .item-card').length;
	$('.category-carousel').owlCarousel({
		...
		responsive:{
			...
			600:{
				items: Math.min(2, categoryCarouselCount)
			},
			900:{
				items: Math.min(3, categoryCarouselCount)
			},
			1000:{
				items: Math.min(4, categoryCarouselCount)
			}
		}
	});
